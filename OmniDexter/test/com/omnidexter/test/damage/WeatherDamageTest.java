...
public class WeatherDamageTest {
	...
	public void testApplyDamagingWeather_Hail_no_immunitity() {
		...
		team.addTeamMate(new ActivePokemon(Species.QUAGSIRE));
	...
	public void testApplyDamagingWeather_Hail_with_ice_immunity() {
		...
		weather.setHail(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.JYNX));
	...
	public void testApplyDamagingWeather_Hail_with_MagicGuard() {
		...
		weather.setHail(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.CLEFABLE));
	...
	public void testApplyDamagingWeather_Hail_with_Overcoat() {
		...
		weather.setHail(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.PINECO));
	...
	public void testApplyDamagingWeather_Hail_with_Ice_Body() {
		...
		weather.setHail(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.SPHEAL));
	...
	public void testApplyDamagingWeather_Hail_with_Snow_Cloak() {
		...
		weather.setHail(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.FROSLASS));
	...
	public void testApplyDamagingWeather_Sand_with_Rock_Typing() {
		...
		weather.setSand(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.NOSEPASS));
	...
	public void testApplyDamagingWeather_Sand_with_Steel_Typing() {
		...
		weather.setSand(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.MAWILE));
	...
	public void testApplyDamagingWeather_Sun_SolarPower() {
		...
		weather.setSun(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.CHARIZARD));
	...
	public void testApplyDamagingWeather_Sun_DrySkin() {
		...
		weather.setSun(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.TOXICROAK));
	...
	public void testApplyDamagingWeather_Sand_with_Ground_Typing() {
		...
		weather.setSand(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.SANDSHREW));
	...
	public void testApplyHealingWeather_Rain_Hydration_Cure() {
		...
		weather.setRain(5);
		Team team = new DeepTeam();
		team.addTeamMate(new ActivePokemon(Species.SEEL));
