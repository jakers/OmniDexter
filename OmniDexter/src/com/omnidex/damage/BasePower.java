...
public class BasePower {
	...
	public static int Facade(Pokemon attacker) {
		...
		boolean boostsFacade = attacker.isBurnt() || attacker.isParalyzed()
	...
	public static int GyroBall(ActivePokemon attacker, ActivePokemon target) {
		return (int) (25 * (target.getCurrSpe() / (double) attacker
				.getCurrSpe()));
	}
	...
	public static int HeatCrashOrHeavySlam(ActivePokemon attacker,
