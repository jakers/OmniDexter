...
public class TestTeamBuilder {
	...
	public static Team getMonoTestTeamOne() {
		Team team = new DeepTeam();
		ActivePokemon t1P1 = new ActivePokemon();
		...
		t1P1.setMove(Move.NONE, 2);
		t1P1.setMove(Move.NONE, 3);
		team.addTeamMate(t1P1);
		return team;
	}

	public static Team getMonoTestTeamWithPriority() {
		Team team = new DeepTeam();
		ActivePokemon t1P1 = new ActivePokemon();
		...
		t1P1.setSpeEv(252);
		t1P1.setCurrHp(1);
		t1P1.setMove(Move.BUBBLE, 0);
		t1P1.setMove(Move.AQUA_JET, 1);
		t1P1.setMove(Move.NONE, 2);
		t1P1.setMove(Move.NONE, 3);
		team.addTeamMate(t1P1);
		return team;
	...
	public static Team getMonoTestTeamWithOutPriority() {
		Team team = new DeepTeam();
		ActivePokemon t1P1 = new ActivePokemon();
		t1P1.setSpecies(Species.CHARMANDER);
		t1P1.setAbility(Ability.BLAZE);
	...
	public static Team getMonoTestTeamTwo() {
		Team team = new DeepTeam();
		ActivePokemon t1P1 = new ActivePokemon();
		t1P1.setSpecies(Species.SQUIRTLE);
		t1P1.setAbility(Ability.TORRENT);
	...
	public static Team getDualTestTeamOne() {
		Team team = new DeepTeam();
		ActivePokemon t1P1 = new ActivePokemon();
		t1P1.setSpecies(Species.CHARMANDER);
		t1P1.setAbility(Ability.BLAZE);
		...
		ActivePokemon t1P2 = new ActivePokemon();
		t1P2.setSpecies(Species.BULBASAUR);
		t1P2.setAbility(Ability.OVERGROW);
		t1P2.setLevel(5);
		t1P2.setAtkEv(252);
		t1P2.setSpeEv(252);
		t1P2.setMove(Move.VINE_WHIP, 0);
		t1P2.setMove(Move.TACKLE, 1);
		t1P2.setMove(Move.NONE, 2);
		t1P2.setMove(Move.NONE, 3);
	...
	public static Team getStarterTestTeam() {
		...
		ActivePokemon t1P3 = new ActivePokemon();
	...
	public static Team getTestTeamTwo() {
		...
		ActivePokemon t2P1 = new ActivePokemon();
		...
		t2.addTeamMate(t2P1);
		ActivePokemon t2P2 = new ActivePokemon();
